...
class GOT10kDataset(DatasetBase):
    ...
    def __getitem__(self, item: int) -> Dict:
        hsi_img_files, material_img_files, fc_img_files, anno = self._state["dataset"][item]

        anno = xywh2xyxy(anno)
        sequence_data = dict(hsi_img=hsi_img_files, material_img=material_img_files, fc_img=fc_img_files, anno=anno)
