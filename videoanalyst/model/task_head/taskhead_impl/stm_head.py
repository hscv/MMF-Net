...
class STMHead(ModuleBase):
    ...
    def update_params(self):
        ...
        # print ('self.q_size = ', q_size)
        # print ('self.score_size = ', self.score_size)
        # print ('self.total_stride = ', self.total_stride)
        # print ('self.score_offset = ', self.score_offset)
        # print ('self._hyper_params[in_channels] = ', self._hyper_params["in_channels"])
        # raise Exception
