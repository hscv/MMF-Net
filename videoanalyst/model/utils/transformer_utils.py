...
class PositionEmbeddingSine(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor, tensorParam=None, maskParam=None):
        if tensorParam is not None: x = tensorParam
        if maskParam is not None: mask = maskParam
        else:
